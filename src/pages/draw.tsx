...
export default function Draw() {
  ...
  let { text, geogebra, name } = router.query;
  ...
  text = (text instanceof Array ? text.join('') : text) ?? '새로운 메모!';
  geogebra = (geogebra instanceof Array ? geogebra.join('') : geogebra) ?? defaultGeogebra;
