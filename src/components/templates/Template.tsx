  ...
  return (
    <div>
      <div>
        ...
        >
          <div className="tw-relative tw-flex tw-items-center tw-justify-between tw-w-full tw-py-4 tw-mx-auto">
        ...
        <main className="tw-flex tw-flex-col tw-w-full tw-px-4 sm:tw-px-8">
          <div className="tw-flex tw-flex-col tw-justify-center tw-w-full tw-mx-auto">
